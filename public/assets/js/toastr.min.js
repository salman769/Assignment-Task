...
$( ".target" ).change(function() {
  ...
  $("a#emp_upload_imagelink").on("click", function(){

    $("input#emp_image").click();
});
...
$('#emp_image').on('change', function(){
   ...
   $("img#emp_user_image").attr("src",window.URL.createObjectURL(this.files[0]));
   $("div.photo-upload-content-area").hide();
   $("img#emp_user_image").show();
